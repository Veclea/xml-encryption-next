...
const keyInfoTemplate = ({ encryptionPublicCert, encryptedKey, keyEncryptionMethod, keyEncryptionDigest, mgfAlgorithm }) => {
    ...
    const mgfBlock = mgfAlgorithm
        ? `<xenc11:MGF xmlns:xenc11="http://www.w3.org/2009/xmlenc11#" Algorithm="${escapeHtml(mgfAlgorithm)}"></xenc11:MGF>`
        : '';
...
<KeyInfo xmlns="http://www.w3.org/2000/09/xmldsig#">
  <e:EncryptedKey xmlns:e="http://www.w3.org/2001/04/xmlenc#">
    <e:EncryptionMethod Algorithm="${escapeHtml(keyEncryptionMethod)}">
      <ds:DigestMethod xmlns:ds="http://www.w3.org/2000/09/xmldsig#" Algorithm="http://www.w3.org/2000/09/xmldsig#${escapeHtml(keyEncryptionDigest)}" />
      ${mgfBlock}
    </e:EncryptionMethod>
    <KeyInfo>
