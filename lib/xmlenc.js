...
function encryptKeyInfoWithScheme(symmetricKey, options, padding, callback) {
    ...
    try {
        ...
        let params = {
            ...
            keyEncryptionMethod: options.keyEncryptionAlgorithm, //例如:http://www.w3.org/2009/xmlenc11#rsa-oaep
            keyEncryptionDigest: options.keyEncryptionDigest,//例如:http://www.w3.org/2001/04/xmlenc#sha512  oaep hash函数
            mgfAlgorithm: options.mgfAlgorithm,//例如:http://www.w3.org/2009/xmlenc11#mgf1sha256 oaep 掩码函数函数
        };
