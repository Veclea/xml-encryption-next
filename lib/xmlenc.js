...
function decryptKeyInfo(doc, options) {
    ...
    if (keyDigestMethod) {
        ...
        console.log(keyDigestMethodAlgorithm)
        console.log("我来看一下====")
...
/*function decryptKeyInfoWithScheme(encryptedKey, options, padding, oaepHash) {
  console.log("开试了")
  console.log(encryptedKey.textContent)
  console.log(oaepHash)
  console.log(padding)
...
try{
    const decrypted = crypto.privateDecrypt({ key: options.key, padding:crypto.constants.RSA_NO_PADDING, oaepHash:"sha256"}, key);
...
function decryptKeyInfoWithScheme(encryptedKey, options, padding, oaepHash) {
    console.log("开试了11111111111111111");
    console.log(encryptedKey.textContent);
    console.log(oaepHash);
    console.log(padding);
